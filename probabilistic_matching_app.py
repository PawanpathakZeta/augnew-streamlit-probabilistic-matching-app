...
if match_button and unmatched_file_valid_flag and customer_file_valid_flag:
    ...
    ## <- Data Cleaning end
        ...
        ax.plot(x_threshold, y_num_match, plot_blue_colour, linewidth = 2.5, marker= 'o')
        plt.fill_between(x_threshold, y_num_match, color=primaryColor)
        ...
        # plt.title("Number Matched Records per Threshold", color=textColor, fontsize =12, y=1.1)
        # Add cosmetics
        ...
        col_threshold_left.markdown(f'Optimal Threshold: {select_optimal_elbow_point(best_threshold)} (based on number of matches vs quality)')
        col5.subheader(' ')
        ...
        # plt.title("Store Statistics Distribution", color=textColor, fontsize =16, loc='left')
        ...
        #plt.title("Store Statistics Distribution", color=textColor, fontsize=16, y=1.1)
...
if st.session_state['valid_flag']:
    ...
    if  unmatched_file_valid_flag and customer_file_valid_flag:
        ...
        ax.spines['right'].set_color('lightgrey')
        ax.spines['left'].set_color('lightgrey')
        plt.title("NAs on unmatched data", color=textColor, fontsize =13)
        # left_na_plot_title = '<p style="color:black; font-size: 20px; text-align: center;">NAs on unmatched data</p>'
        # col3.markdown(left_na_plot_title, unsafe_allow_html=True)
        ...
        plt.title("NAs on customer data", color=textColor, fontsize =13)
        # right_na_plot_title = '<p style="color:black; font-size: 20px; text-align: center;">NAs on cutomer data</p>'
        # col4.markdown(right_na_plot_title, unsafe_allow_html=True)
